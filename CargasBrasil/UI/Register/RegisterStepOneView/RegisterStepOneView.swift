...
struct RegisterStepOneView: View {
    ...
    private let formatter = CpfCnpjFormatter()
            ...
            ZStack {
                ...
                VStack {
                            ...
                            Group {
                                if isCompany {
                                    ...
                                    CustomTextField(sfIncon: "at", hint: "CNPJ", value: $cpfCnpj)
                                        ...
                                        .onChange(of: cpfCnpj) { newValue in
                                                             cpfCnpj = formatter.applyMask(newValue, isCompany: true)
                                        }
                                } else {
                                    ...
                                    CustomTextField(sfIncon: "at", hint: "CPF", value: $cpfCnpj)
                                        .keyboardType(.numberPad)
                                        .onChange(of: cpfCnpj) { newValue in
                                                              cpfCnpj = formatter.applyMask(newValue, isCompany: false)
                                                          }
                                ...
                                CustomTextField(sfIncon: "at", hint: "Telefone", value: $phone)
                                    .onChange(of: phone) { newValue in
                                           phone = phoneFormatter.applyMask(newValue)
                                       }
                    ...
                    NavigationLink(destination: RegisterStepTwoView(
                        ...
                        cpfCnpj: formatter.removeMask(cpfCnpj),
                        nameUser: nameUser,
                        numberCnh: numberCnh,
                        plateVheicle: plateVheicle,
                        typeVheicle: typeVheicle,
                        phone: phoneFormatter.removeMask(phone),
                        imageCNH: imageCNH,
                        isCompany: isCompany
